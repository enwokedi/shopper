                ...
                <form novalidate="" class="contact-form" id="contactform" method="post" action="/store/message">
                    ...
                    <div class="form-text-wrap clearfix {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <div class="contact-subject">
                            <label></label>
                            <input type="text" placeholder="Subject" aria-required="true" size="30" value="Call Me Back" name="subject" id="subject">
                        </div>
                    </div>
                    <div class="contact-message clearfix">
                        <label></label>
                        <textarea class="" tabindex="4" placeholder="Message" name="message" required>Please call me back at your earliest convinience.</textarea>
                    </div>
